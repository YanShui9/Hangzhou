        ...
        <div v-show="activeIndex === '8'" class="tab-content">
          ...
          <div class="audit-conclusion">
            ...
            <div class="radio-group">
              ...
              <el-radio v-model="auditForm.finalResult" label="3">直接判D档</el-radio>
            </div>
...
export default {
  ...
  methods: {
    ...
    showConfirmDialog() {
      ...
      this.confirmDialogTitle = this.auditForm.finalResult === '1' ? '审核通过' : (this.auditForm.finalResult === '3' ? '直接判D档' : '审核驳回')
    ...
    async confirmAudit() {
      ...
      try {
        ...
        this.$message.success(msgMap[this.auditForm.finalResult] || '审核完成')
        this.confirmDialogVisible = false
        this.goBack()
      } catch (e) {
        console.error('审核失败', e)
