    ...
    <el-card class="title-card" shadow="never">
      <div class="title-content">
        ...
        <div class="enterprise-tags">
          <el-tag v-if="hasHonor('国高')" type="success">国高</el-tag>
          <el-tag v-if="hasHonor('小巨人')" type="primary">小巨人</el-tag>
          <el-tag v-if="hasHonor('单项冠军')" type="warning">单项冠军</el-tag>
          <el-tag v-if="hasHonor('省科')" type="info">省科</el-tag>
          <el-tag v-if="hasHonor('省专')" type="danger">省专</el-tag>
        </div>
      </div>
    </el-card>
      ...
      <div class="info-grid">
        ...
        <div class="info-column">
          ...
          <div class="info-row">
            ...
            <span class="info-value">{{ enterpriseData.enterpriseAddress || '-' }}</span>
          </div>
          <div class="info-row">
        ...
        <div class="info-column">
          <div class="info-row">
            ...
            <span class="info-value">{{ enterpriseData.creditCode || '-' }}</span>
          </div>
          <div class="info-row">
        ...
        <div class="info-column">
          <div class="info-row">
            ...
            <span class="info-value">{{ enterpriseData.districtName || '-' }}</span>
          </div>
          <div class="info-row">
        ...
        <div class="info-column">
          ...
          <div class="info-row">
            ...
            <span class="info-value">{{ enterpriseData.settledTime || '-' }}</span>
          </div>
          <div class="info-row">
...
export default {
  ...
  methods: {
    hasHonor(keyword) {
      const honor = this.enterpriseData.enterpriseHonor || ''
      return honor.includes(keyword)
    },
    async loadData() {
