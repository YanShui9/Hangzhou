              ...
              <div class="info-column">
                <div class="info-row">
                  ...
                  <el-select v-model="formData.landNature" placeholder="请选择" class="info-select">
                    <el-option label="国有土地" :value="1" />
                    <el-option label="集体土地" :value="2" />
              ...
              <div class="info-column">
                <div class="info-row">
                  ...
                  <el-select v-model="formData.operationNature" placeholder="请选择" class="info-select">
                    <el-option label="政府运营" :value="1" />
                    <el-option label="企业运营" :value="2" />
                    <el-option label="混合运营" :value="3" />
                  </el-select>
                </div>
                <div class="info-row">
...
<script>
import { addPark, updatePark, getParkById } from '@/api/park'
...
export default {
  ...
  methods: {
    loadParkData() {
      getParkById(this.parkId).then(res => {
        const data = res.data
        this.formData = {
          ...this.formData,
          ...data
    ...
    handleSubmit() {
      ...
      const api = this.isEdit ? updatePark : addPark
