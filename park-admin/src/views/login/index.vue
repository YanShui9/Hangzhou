      ...
      <div class="login-form-area">
        <div class="login-card">
          ...
          <div class="test-accounts">
            ...
            <div class="test-list">
              <span class="test-item" @click="fillAccount('admin', 1)">admin</span>
              <span class="test-item" @click="fillAccount('district', 2)">district</span>
              <span class="test-item" @click="fillAccount('park', 3)">park</span>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    fillAccount(username, roleType) {
      this.loginForm.username = username
      this.loginForm.password = '123456'
      this.loginForm.roleType = roleType
    }
  }
}
</script>
