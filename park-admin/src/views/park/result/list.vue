  ...
  <div class="app-container">
    <el-card>
      ...
      <el-table :data="list" border stripe style="width: 100%;" v-loading="loading">
        ...
        <el-table-column prop="totalScore" label="评价总分" width="150" align="center">
          <template slot-scope="scope">
            <span style="font-weight: bold; color: #67C23A; font-size: 18px;">{{ scope.row.totalScore || '-' }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="grade" label="绩效分档" width="120" align="center">
          <template slot-scope="scope">
