  ...
  <div class="enterprise-indicator-container">
    ...
    <div class="filter-bar">
      <div class="filter-left">
        ...
        <el-select v-model="queryParams.industryName" placeholder="所属行业" clearable size="small" style="width: 130px">
    ...
    <el-table v-loading="loading" :data="list" border stripe size="mini" style="width: 100%" class="indicator-table" :header-cell-style="headerCellStyle">
      ...
      <el-table-column prop="rdInvestment" label="研发投入(万元)" width="140" align="right" />
      <el-table-column prop="patentCount" label="专利数量" width="90" align="center" />
...
export default {
  ...
  data() {
    return {
      queryParams: {
        enterpriseName: '', creditCode: '', industryName: '',
        year: new Date().getFullYear(), grade: '',
        pageNum: 1, pageSize: 20
      },
      industryOptions: ['生物医药', '电子信息', '高端装备制造', '新材料', '新能源', '其他'],
  ...
  methods: {
    ...
    getList() {
      ...
      const params = {
        ...
        industryName: this.queryParams.industryName || undefined,
    ...
    resetQuery() {
      this.queryParams = { enterpriseName: '', creditCode: '', industryName: '', year: new Date().getFullYear(), grade: '', pageNum: 1, pageSize: 20 }
      this.getList()
    },
    handleExport() {
