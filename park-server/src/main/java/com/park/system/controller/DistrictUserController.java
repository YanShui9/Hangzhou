...
public class DistrictUserController {
    ...
    public R<PageResult<SysUser>> getParkAdminPage(UserQueryDTO queryDTO, HttpServletRequest request) {
        // 获取当前区县管理员信息
    ...
    public R<Void> saveParkAdmin(@Valid @RequestBody UserSaveDTO dto, HttpServletRequest request) {
        // 获取当前区县管理员信息
        SysUser currentUser = getCurrentUser(request);
    ...
    public R<Void> updateParkAdmin(@PathVariable Long id, @Valid @RequestBody UserSaveDTO dto, HttpServletRequest request) {
        // 校验权限
        checkPermission(id, request);
    ...
    public R<Void> deleteParkAdmin(@PathVariable Long id, HttpServletRequest request) {
        // 校验权限
        checkPermission(id, request);
